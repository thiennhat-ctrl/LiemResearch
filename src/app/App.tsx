...
const PUBLIC_PATHS = new Set(['/', '/explore', '/rankings', '/login', '/register', '/verify-otp', '/forgot-password', '/auth/callback']);
      ...
      <ToastProvider>
        ...
        <Suspense fallback={<LoadingSpinner fullPage label="Loading page..." />}>
          <Routes>
            ...
            <Route path="/settings/:section" element={<ProtectedRoute><UserProfileSettingsPage /></ProtectedRoute>} />
