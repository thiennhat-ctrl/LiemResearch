      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="p-5">
          ...
          {message && (
            ...
            <div className="mb-4 rounded-lg border border-[#e2e8f0] bg-[#ffffff] p-4 shadow-sm">
            <div className="flex flex-col gap-4 lg:flex-row">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  maxLength={128}
                  className="w-full pl-10 pr-4 py-3 border border-[#cbd5e1] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#bfdbfe] bg-[#ffffff]"
                />
              </div>
              <div className="relative lg:w-48">
                <Filter className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#64748b]" size={20} />
                <select
                  value={yearFilter}
                  onChange={(e) => {
                    setPage(1);
                  ...
                  className="pl-10 pr-8 py-3 border border-[#cbd5e1] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#bfdbfe] bg-[#ffffff] appearance-none"
                >
