...
export function Sidebar({ role = 'user' }: SidebarProps) {
  ...
  return (
    <aside className="sticky top-0 z-30 border-b border-[#e2e8f0] bg-[#ffffff]/95 pt-16 backdrop-blur md:h-screen md:w-60 md:shrink-0 md:border-b-0 md:border-r md:pt-[73px]">
